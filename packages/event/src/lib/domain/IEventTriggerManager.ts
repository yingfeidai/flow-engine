...
export interface IEventTriggerManager<TProperties = IEventProperties> extends IManagerInjectable<IEventTriggerManagerInjectable> {
...
export interface IEventTriggerManagerInjectable<TProperties = IEventProperties> {
